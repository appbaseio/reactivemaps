				...
				<Base>
					...
					<Footer>
						...
						<Footer.Links>
							<Footer.List>
								<Title>Documentation</Title>
								<li><a href="https://docs.appbase.io/docs/reactivesearch/v3/overview/quickstart/">Quick Start</a></li>
								<li><a href="https://docs.appbase.io/docs/reactivesearch/v3/list/singlelist/">List Components</a></li>
								<li><a href="https://docs.appbase.io/docs/reactivesearch/v3/search/searchbox/">Search Components</a></li>
								<li><a href="https://docs.appbase.io/docs/reactivesearch/v3/result/reactivelist/">Result Components</a></li>
							</Footer.List>

							<Footer.List>
								<Title>Community</Title>
								<li><a href="https://github.com/appbaseio/reactivesearch/discussions">GitHub</a></li>
								<li><a href="https://twitter.com/appbaseio">Twitter</a></li>
							</Footer.List>

							<Footer.List>
								<Title>Helpful Tools</Title>
								<li><a href="https://dejavu.appbase.io">Data Browser</a></li>
                                <li><a href="https://github.com/appbaseio/reactivesearch-api">ReactiveSearch API server</a></li>
							</Footer.List>
