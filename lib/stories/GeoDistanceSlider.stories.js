...
import { ReactiveBase, ReactiveMap, GeoDistanceSlider, AppbaseSensorHelper as helper } from "../app.js";

import { Img } from "./Img.js";
var historyPin = require("./placeholder.svg");

var GeoDistanceSliderDefault = function (_Component) {
	_inherits(GeoDistanceSliderDefault, _Component);

	function GeoDistanceSliderDefault(props) {
		_classCallCheck(this, GeoDistanceSliderDefault);
	...
	GeoDistanceSliderDefault.prototype.componentDidMount = function componentDidMount() {
		helper.ResponsiveStory();
	};

	GeoDistanceSliderDefault.prototype.onPopoverTrigger = function onPopoverTrigger(marker) {
	...
	GeoDistanceSliderDefault.prototype.render = function render() {
		return React.createElement(
			ReactiveBase,
			{
			...
			React.createElement(
				...
				React.createElement(
					...
					React.createElement(GeoDistanceSlider, _extends({
	...
	return GeoDistanceSliderDefault;
}(Component);

export default GeoDistanceSliderDefault;
