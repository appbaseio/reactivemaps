...
import { ReactiveBase, DatePicker, ReactiveMap, AppbaseSensorHelper as helper } from "../app";
import { Img } from "./Img";
...
var DatePickerDefault = function (_Component) {
	...
	DatePickerDefault.prototype.onPopoverTrigger = function onPopoverTrigger(marker) {
