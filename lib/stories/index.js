...
var _GeoDistanceSlider3 = require("@appbaseio/reactivemaps-manual/docs/v1.0.0/map-components/GeoDistanceSlider.md");
...
var _GeoDistanceDropdown3 = require("@appbaseio/reactivemaps-manual/docs/v1.0.0/map-components/GeoDistanceDropdown.md");
...
var _PlacesSearch3 = require("@appbaseio/reactivemaps-manual/docs/v1.0.0/map-components/PlacesSearch.md");
...
var _ReactiveMap3 = require("@appbaseio/reactivemaps-manual/docs/v1.0.0/map-components/ReactiveMap.md");
...
var _SingleList3 = require("@appbaseio/reactivemaps-manual/docs/v1.0.0/components/SingleList.md");
...
var _MultiList3 = require("@appbaseio/reactivemaps-manual/docs/v1.0.0/components/MultiList.md");
...
var _SingleDropdownList3 = require("@appbaseio/reactivemaps-manual/docs/v1.0.0/components/SingleDropdownList.md");
...
var _MultiDropdownList3 = require("@appbaseio/reactivemaps-manual/docs/v1.0.0/components/MultiDropdownList.md");
...
var _SingleRange3 = require("@appbaseio/reactivemaps-manual/docs/v1.0.0/components/SingleRange.md");
...
var _MultiRange3 = require("@appbaseio/reactivemaps-manual/docs/v1.0.0/components/MultiRange.md");
...
var _SingleDropdownRange3 = require("@appbaseio/reactivemaps-manual/docs/v1.0.0/components/SingleDropdownRange.md");
...
var _MultiDropdownRange3 = require("@appbaseio/reactivemaps-manual/docs/v1.0.0/components/MultiDropdownRange.md");
...
var _DataSearch3 = require("@appbaseio/reactivemaps-manual/docs/v1.0.0/components/DataSearch.md");
...
var _NestedList3 = require("@appbaseio/reactivemaps-manual/docs/v1.0.0/components/NestedList.md");
...
var _RangeSlider3 = require("@appbaseio/reactivemaps-manual/docs/v1.0.0/components/RangeSlider.md");
...
var _NumberBox3 = require("@appbaseio/reactivemaps-manual/docs/v1.0.0/components/NumberBox.md");
...
})).add("With defaultSelected", (0, _withReadme2.default)(removeFirstLine(_GeoDistanceSlider4.default), function () {
	return _react2.default.createElement(_GeoDistanceSlider2.default, {
		defaultSelected: {
			location: 'London',
			distance: 5
...
(0, _storybook.storiesOf)("ReactiveMap", module).addDecorator(_storybookAddonKnobs.withKnobs).add("Basic", (0, _withReadme2.default)(removeFirstLine(_ReactiveMap4.default, 3), function () {
	return _react2.default.createElement(_ReactiveMap2.default, null);
})).add("With Title", (0, _withReadme2.default)(removeFirstLine(_ReactiveMap4.default, 3), function () {
	return _react2.default.createElement(_ReactiveMap2.default, {
		title: "Reactive Maps"
	});
})).add("With Popover onClick", (0, _withReadme2.default)(removeFirstLine(_ReactiveMap4.default, 3), function () {
	return _react2.default.createElement(_ReactiveMap2.default, {
		title: "Reactive Maps",
		showPopoverOn: "click"
	});
