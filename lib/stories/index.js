...
storiesOf("ReactiveMap", module).addDecorator(withKnobs).add("Basic", withReadme(removeFirstLine(ReactiveMapReadme, 3), function () {
	return React.createElement(ReactiveMapDefault, null);
})).add("With Title", withReadme(removeFirstLine(ReactiveMapReadme, 3), function () {
	return React.createElement(ReactiveMapDefault, {
		title: "Reactive Maps"
	});
})).add("With Popover onClick", withReadme(removeFirstLine(ReactiveMapReadme, 3), function () {
	return React.createElement(ReactiveMapDefault, {
		title: "Reactive Maps",
		showPopoverOn: "click"
	});
})).add("With Popover onMouseOver", withReadme(removeFirstLine(ReactiveMapReadme), function () {
	return React.createElement(ReactiveMapDefault, {
		title: "Reactive Maps",
		showPopoverOn: "mouseover"
	});
})).add("Playground", withReadme(removeFirstLine(ReactiveMapReadme), function () {
	return React.createElement(ReactiveMapDefault, {
