...
import { ReactiveBase, SingleDropdownList, ReactiveMap } from "../app";
...
var SingleDropdownListDefault = function (_Component) {
	...
	SingleDropdownListDefault.prototype.onPopoverTrigger = function onPopoverTrigger(marker) {
			...
			React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							"a",
							{ href: marker._source.event.event_url, rel: "noopener noreferrer", target: "_blank" },
...
SingleDropdownListDefault.propTypes = {
